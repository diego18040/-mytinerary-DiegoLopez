...
const Card = ({ data }) => {
  const defaultPhoto = '../assets/underConstruction.jpg'; // Reemplaza con una URL válida
  return (
    <div className="relative flex w-full max-w-[26rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
      <div
        ...
        style={{ backgroundImage: `url(${data.photo || defaultPhoto})`, backgroundSize: 'cover', backgroundPosition: 'center' }}
      >
      ...
      <div className="p-6 pt-3">
        <button className="block w-full rounded-lg bg-gray-900 py-3.5 text-center text-sm font-bold uppercase text-white">
          Reserve
        </button>
      </div>
    </div>
